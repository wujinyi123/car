...
<div class="lunbo container">
    <ul class="lunbo-kuang container">
        <li>
            ...
            <p>荣威550（粤A牌）</p>
            <p>时尚、省油、操控|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥65</i>元/天起</p>
        </li>
        <li>
            <p>4月12日</p>
            <p>荣威REX5</p>
            <p>时尚、空间|SUV|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥140</i>元/天起</p>
        </li>
        <li>
            <p>4月13日</p>
            <p>大众朗逸</p>
            <p>时尚、精致、运动|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥100</i>元/天起</p>
        </li>
        <li>
            <p>4月15日</p>
            <p>现代IX35</p>
        ...
        <li>
            ...
            <p>大众速腾</p>
            <p>时尚、省油、大气|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥60</i>元/天起</p>
        </li>
        <li>
            <p>4月16日</p>
            <p>现代朗动</p>
            <p>时尚、省油、操控|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥120</i>元/天起</p>
        </li>
        <li>
            <p>4月17日</p>
            <p>丰田雷凌</p>
            <p>时尚、舒适、豪华|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥115</i>元/天起</p>
        </li>
        <li>
            <p>4月17日</p>
            <p>沃尔沃XC90</p>
            <p>时尚、空间、多用途|舒适性7座</p>
            <p><i style="color: red;font-size: 20px;">￥550</i>元/天起</p>
        </li>
        <li>
            <p>4月17日</p>
            <p>现代全新胜达</p>
            <p>时尚、省油、舒适|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥225</i>元/天起</p>
        </li>
        <li>
            <p>4月10日</p>
            <p>荣威550（粤A牌）</p>
        ...
        <li>
            ...
            <p>日产轩逸</p>
            <p>时尚、省油、舒适|舒适性5座</p>
            <p><i style="color: red;font-size: 20px;">￥50</i>元/天起</p>
        </li>
    </ul>
</div>
<script>
